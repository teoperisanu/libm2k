...
#include <src/utils/deviceout.hpp>
#include "m2khardwaretrigger_v0.24_impl.hpp"


namespace libm2k {

class M2kOutHardwareTriggerImpl : public M2kHardwareTriggerV024Impl {
public:
	explicit M2kOutHardwareTriggerImpl(struct iio_context *ctx, bool init = true);

	~M2kOutHardwareTriggerImpl() override = default;
